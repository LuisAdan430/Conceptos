...
Claro, la anotación @RolesAllowed se utiliza en aplicaciones Java para restringir el acceso a métodos o clases según los roles de los usuarios autenticados. Es parte del estándar de seguridad JSR 250 y funciona tanto en entornos Java EE / Jakarta EE como en proyectos Spring (aunque en Spring se recomienda usar otras anotaciones como @PreAuthorize).
...
Spring no la soporta de forma predeterminada. Si quieres usar @RolesAllowed en Spring, debes habilitar el soporte a través de @EnableMethodSecurity(jsr250Enabled = true):
